...
extern "C" void ResetCameraData(void* obj)
{
    ...
    F32(obj, 0x128) = F32(lbl_802015B0, 0x48);
    F32(obj, 0x12c) = F32(lbl_802015B0, 0x4c);
    F32(obj, 0x130) = F32(lbl_802015B0, 0x50);
    ...
    F32(obj, 0x170) = F32(lbl_802015B0, 0x54);
    F32(obj, 0x174) = F32(lbl_802015B0, 0x58);
    F32(obj, 0x178) = F32(lbl_802015B0, 0x5c);

    F32(obj, 0x16c) = lbl_8065C8B4;
    S32(obj, 0x188) = 0;
    F32(obj, 0x18c) = lbl_8065C8B0;

    F32(obj, 0x190) = F32(lbl_802015B0, 0x60);
    F32(obj, 0x194) = F32(lbl_802015B0, 0x64);
    F32(obj, 0x198) = F32(lbl_802015B0, 0x68);

    S32(obj, 0x19c) = 0;
    S32(obj, 0x1a0) = 0;
    F32(obj, 0x1a4) = lbl_8065C8B0;

    F32(obj, 0x1a8) = F32(lbl_802015B0, 0x6c);
    F32(obj, 0x1ac) = F32(lbl_802015B0, 0x70);
    F32(obj, 0x1b0) = F32(lbl_802015B0, 0x74);
