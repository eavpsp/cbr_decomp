...
extern "C" void process_card(void* a, void* b, void* c);
...
//80089C5C
extern "C" int LoadFromCard(char* ctx)
{
    process_card(*(void**)(ctx + 0), *(void**)(ctx + 4), *(void**)(ctx + 8));
    return 0;
}

//80089C90
extern "C" int LoadCardHandler(char* obj, void* arg1, void* arg2, void* arg3)
{
    if (*(int*)(obj + 0x6a08) != 0) {
        return 0;
    }
    ...
    *(int*)(lbl_8036AC10 + 0x31c) = 0x1000;
    ...
    OSCreateThread(lbl_8036AC10, (void*)LoadFromCard, obj + 0x6a10, lbl_8036AF38 + 0x1000, 0x1000, 0x10, 1);
