C:\devkitPro\devkitPPC\bin\powerpc-eabi-gcc.exe %1 -S -o %~n1.s -O1 -std=c99 -w -Iinc -IPowerPC_EABI_Support/MSL_C/MSL_Common -Iext/inc/ -Iext/inc/stl
C:\devkitPro\devkitPPC\bin\powerpc-eabi-gcc.exe %1 -c -o %~n1.o -O1 -std=c99 -w -Iinc -IPowerPC_EABI_Support/MSL_C/MSL_Common  -Iext/inc -Iext/inc/stl
